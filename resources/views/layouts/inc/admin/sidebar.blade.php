         ...
         {{-- Orders --}}
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ url('admin/users/create') }}"> Thêm Người Dùng </a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ url('admin/users') }}"> Xem Người Dùng </a></li>
              </ul>
            </div>
          </li>
