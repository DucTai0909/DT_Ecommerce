    ...
    public function destroy(int $product_id){
        ...
        if($product->productImages()){
            foreach($product->productImages() as $image){
                //Kiểm tra xem đường dẫn đến thư mục hình ảnh đó ($image->image) có tồn tại hay không
                // Nếu có thì xóa nó đi, ở đây biến $image là đối tượng hình ảnh sản phẩm
                // thuộc tính image sẽ chứa đường dẫn đến hình ảnh
